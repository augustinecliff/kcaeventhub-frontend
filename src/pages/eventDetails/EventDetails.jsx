...
export default function EventDetails() {
    ...
    return(
        <>
            <div className="sm:h-60 bg-green-200 flex flex-col justify-end  w-full mb-6 rounded-2xl px-6 sm:px-6">
                <div className="bg-gray-100 flex flex-col flex-wrap justify-between items-center mt-16 mb-6 rounded-2xl p-2 sm:p-4 gap-2">
                    <div className="flex justify-center w-fit font-bold text-lg sm:text-2xl">Amapiano tour Sep 2023</div>
                    <div className="flex flex-row gap-2 flex-wrap justify-center">
                        <div className="flex justify-center flex-row bg-gray-300 rounded-3xl w-fit text-base px-4 py-2 gap-2">
