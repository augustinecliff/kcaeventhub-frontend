...
import {SuccessModal} from "../shared/modals/EnrollmentSuccess.jsx";
                            ...
                            loggedInUser()?.email ? (
                                <div className={'group relative'}>
                                    ...
                                    <ul className="text-left menu bg-base-200 rounded-box w-44 absolute right-0 hidden group-hover:block z-10">
                                        <li><a>Welcome <span
                                            className={'font-bold'}>{loggedInUser().firstName}</span></a></li>
                    ...
                    <div className="flex flex-row justify-end items-center text-base gap-x-1">
                        ...
                        <div className="drawer w-fit">
                            ...
                            <div className="drawer-side z-50">
                                ...
                                <ul className="menu p-4 w-72 min-h-full bg-base-200 text-base-content flex flex-col gap-5">
                                    <div className={'flex flex-col gap-4 bg-primary p-4 rounded-2xl'}>
                                        <div className={'flex flex-row items-center w-full justify-between'}>
                                            <svg width="73" height="44" viewBox="0 0 73 44" fill="none"
                                            ...
                                            <img src={'/src/assets/images/kcauLogo.jpeg'}
                                                 className={'w-16 h-16 rounded-full'}/>

                                        </div>

                                        <Link to="/" className="flex flex-wrap items-center gap-1 text-3xl text-white">
                                            <span className="font-semibold">Event</span>
                                            <span>hub</span>
                                            <span className={'badge bg-white font-bold ml-4'}>KCA</span>
                                        </Link>

                                        {
                                            loggedInUser()?.email && (
                                                <ul className="text-left menu bg-base-200 rounded-box w-full right-0 z-10">
                                                    <li><a>Welcome <span
                                                        className={'font-bold'}>{loggedInUser().firstName}</span></a></li>
                                                    <li onClick={() => logoutUser()}><a>Logout</a></li>
                                                </ul>
